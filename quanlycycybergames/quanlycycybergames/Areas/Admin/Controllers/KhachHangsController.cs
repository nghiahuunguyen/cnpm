...
namespace quanlycycybergames.Areas.Admin.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        {
            var taiKhoans = db.KhachHang.ToList();
        ...
        public ActionResult Create([Bind(Include = "ID_KhachHang,TenKhachHang,SDT,GioiTinh")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_KhachHang,TenKhachHang,SDT,GioiTinh")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
